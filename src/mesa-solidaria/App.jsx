...
// --- Designar o mesmo mapa do dashboard da pagina inicial ---
...
<aside className="w-56 bg-[#1e293b] text-gray-400 p-4 flex flex-col shadow-xl">
  {/* LOGO COM ROTA PARA HOME */}
  <Link 
    to="/" 
    className="text-white text-2xl font-light px-2 mb-8 tracking-tight uppercase not-italic hover:opacity-80 transition-opacity cursor-pointer block">Food<span className="text-orange-500 font-black">Care</span>
  </Link>
